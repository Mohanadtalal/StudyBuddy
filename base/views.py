...
def home(request):
    ...
    return render(request,'home.html',{'rooms':rooms,'topics':topics,'rooms_count':rooms_count , 'room_messages':room_messages})
...
def userProfile(request,pk):
    ...
    return render(request,'profile.html', {'user':user,'rooms':rooms , 'room_messages': room_messages , 'topics':topics})
...
def activityPage(request):
    ...
    return render(request , 'activity.html',{'rooms_messages':rooms_messages})